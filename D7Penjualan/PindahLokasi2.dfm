object PindahLokasi2Frm: TPindahLokasi2Frm
        ...
        object PanelBrowse: TPanel
          ...
          object wwDBGrid2: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'NO_BUKTI'#9'14'#9'NOTA'#9'F'#9'ORDER MARKETING'
              'NO_KONTRAK'#9'22'#9'NO KONTRAK'#9'F'#9'ORDER MARKETING'
              'TGL_OM'#9'11'#9'TANGGAL'#9'F'#9'ORDER MARKETING'
              'TGL_KIRIM'#9'12'#9'KIRIM'#9'F'#9'ORDER MARKETING'
              'KODE_BRG'#9'8'#9'KODE'#9'F'#9'ISI BARANG'
              'NAMA_BRG'#9'20'#9'NAMA'#9'F'#9'ISI BARANG'
              'SATUAN'#9'6'#9'SAT'#9'F'#9'ISI BARANG'
              'QTY2'#9'8'#9'QTY'#9'F'#9'ISI BARANG'
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
        ...
        '/*select * from (select distinct a.*,b.nama_rekanan,b.no_bukti a' +
        's no_kontrak from ipisma_db2.vpindahlokasi2frm a, ipisma_db2.vso' +
        'frm b'
      'where a.no_bukti=b.no_nota order by a.no_nota)*/'
      
        'select * from (select a.*,b.nama_rekanan,b.no_bukti as no_kontra' +
        'k from ipisma_db2.vpindahlokasi2frm a, '
      
        '(select z.no_nota,x.nama_rekanan,z.no_bukti from ipisma_db2.bukt' +
        'i z, ipisma_db1.rekanan x where z.kd_rekanan=x.kd_rekanan) b'
      'where a.no_bukti=b.no_nota order by a.no_nota)')
    QBEDefinition.QBEFieldDefs = {
      ...
      
      000000}
    ReadOnly = True
  ...
  object QMaster: TOracleDataSet
    ...
    object QMasternitip: TFloatField
      FieldKind = fkCalculated
      FieldName = 'nitip'
      Calculated = True
    end
  ...
  object QItem: TOracleDataSet
    SQL.Strings = (
        ...
        'e.qty9 as qty_perkiraan ,b.kd_sub_lokasi, a.hrg_jual,e.hrg, e.hr' +
        'g2'
    ...
    Variables.Data = {
      ...
      2D313831302D3150303032310000000000040000003A54474C0C000000070000
      0078760C0101010100000000}
    QBEDefinition.QBEFieldDefs = {
      ...
      0000000000030000004852470100000000000400000048524732010000000000}
    ReadOnly = True
    QueryAllRecords = False
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(qty3) as t1, sum(qty4) as t2, sum(qty3*qty4) as t3 fr' +
        'om ipisma_db2.bukti_detail'
      'where ibukti=:ibukti')
    Variables.Data = {
      0300000001000000070000003A4942554B544903000000040000000B11000000
      000000}
    QBEDefinition.QBEFieldDefs = {
      0400000003000000020000005431010000000000020000005432010000000000
      020000005433010000000000}
    Session = DMFrm.OS
    Left = 552
    Top = 408
  ...
  object QCekBuktiSisa: TOracleDataSet
    SQL.Strings = (
        ...
        'select nvl(sum(a.qty7),0)as qty_sisa from ipisma_db2.bukti_detai' +
  ...
  object QCekBuktiSisa1: TOracleDataSet
    SQL.Strings = (
        ...
        'select qty9-(sum(qty2)+:qty) as qty_sisa  from ipisma_db2.bukti_' +
        'detail a, ipisma_db2.bukti b'
      
        'where a.kd_item=:item and b.no_bukti=:nota and a.ibukti=b.ibukti' +
        ' and b.kd_transaksi='#39'791'#39' and b.ispost = '#39'1'#39
      'group by qty9')
    Variables.Data = {
      0300000003000000050000003A4954454D050000000700000030313630323500
      00000000050000003A4E4F544105000000100000003938352D313731312D3050
      303030350000000000040000003A515459040000000800000000000000000000
      0000000000}
    QBEDefinition.QBEFieldDefs = {0400000001000000080000005154595F53495341010000000000}
    Session = DMFrm.OS
    Left = 640
    ...
    object QCekBuktiSisa1SISA: TFloatField
      FieldKind = fkCalculated
      FieldName = 'SISA'
      Calculated = True
    end
  ...
  object QSO: TOracleDataSet
    SQL.Strings = (
      ...
      'order by no_nota')
    Variables.Data = {
      0300000001000000080000003A5046494C544552050000001300000030313536
      2F5050542D54464F2F58492F31380000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000009000000070000004E4F5F4E4F5441010000000000080000004E4F5F
      ...
      0100000000000300000050504E010000000000020000004D55010000000000}
    Session = DMFrm.OS
    Left = 312
    Top = 384
  ...
  object QCekPPN: TOracleDataSet
    SQL.Strings = (
      'select d.ispjk'
      'from ipisma_db2.vsofrm d '
      'where d.no_nota=:no_nota ')
    Variables.Data = {
      0300000001000000080000003A4E4F5F4E4F544105000000100000003938352D
  ...
  object QSO1: TOracleDataSet
    SQL.Strings = (
        ...
        'select distinct no_nota, no_bukti, jns_order, kode, tanggal, tgl' +
        '_kirim, nama_rekanan from ipisma_db2.vsofrm'
  ...
  object QCalonSuplier: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db2.vcustomer where kd_rekanan=:rekanan'
      'order by nama_rekanan')
    Variables.Data = {
      0300000001000000080000003A52454B414E414E0300000004000000AB860100
      00000000}
    QBEDefinition.QBEFieldDefs = {
      ...
      0000000B00000042415441535F4B4952494D010000000000070000004953414B
      544946010000000000}
    QueryAllRecords = False
    Session = DMFrm.OS
    Left = 464
  ...
  object QSOcek: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db2.vsofrm_detail t'
      'where no_nota = :pfilter and kode_brg=:brg')
    Variables.Data = {
      0300000002000000080000003A5046494C54455205000000100000003938352D
      313731322D3050303030310000000000040000003A4252470500000007000000
      3031363032350000000000}
    QBEDefinition.QBEFieldDefs = {
      
      0053415455414E010000000000}
    Session = DMFrm.OS
    Left = 224
    Top = 408
    object QSOcekNO_NOTA: TStringField
      FieldName = 'NO_NOTA'
      Required = True
      Size = 22
    end
    object QSOcekNO_BUKTI: TStringField
      FieldName = 'NO_BUKTI'
      Size = 22
    end
    object QSOcekTANGGAL: TDateTimeField
      FieldName = 'TANGGAL'
    end
    object QSOcekSTATUS: TStringField
      FieldName = 'STATUS'
      Size = 10
    end
    object QSOcekKD_TRANSAKSI: TStringField
      FieldName = 'KD_TRANSAKSI'
      Size = 3
    end
    object QSOcekMU: TStringField
      FieldName = 'MU'
      Size = 3
    end
    object QSOcekKODE: TFloatField
      FieldName = 'KODE'
      Required = True
    end
    object QSOcekNAMA_REKANAN: TStringField
      FieldName = 'NAMA_REKANAN'
      Size = 50
    end
    object QSOcekPPN: TStringField
      FieldName = 'PPN'
      Size = 3
    end
    object QSOcekTGL_KIRIM: TDateTimeField
      FieldName = 'TGL_KIRIM'
    end
    object QSOcekKODE_BRG: TStringField
      FieldName = 'KODE_BRG'
      Size = 50
    end
    object QSOcekNAMA_BRG: TStringField
      FieldName = 'NAMA_BRG'
      Required = True
      Size = 50
    end
    object QSOcekQTY: TFloatField
      FieldName = 'QTY'
    end
    object QSOcekHARGA: TFloatField
      FieldName = 'HARGA'
    end
    object QSOcekSUB_TOTAL: TFloatField
      FieldName = 'SUB_TOTAL'
    end
    object QSOcekPPN10: TFloatField
      FieldName = 'PPN10'
    end
    object QSOcekDPP: TFloatField
      FieldName = 'DPP'
    end
    object QSOcekQTY7: TFloatField
      FieldName = 'QTY7'
    end
    object QSOcekQTY9: TFloatField
      FieldName = 'QTY9'
    end
    object QSOcekSATUAN: TStringField
      FieldName = 'SATUAN'
      Size = 12
    end
  end
  object QSOcek1: TOracleDataSet
    SQL.Strings = (
      
        'select no_bukti, kode_brg, nama_brg, sum(qty2) as total from ipi' +
        'sma_db2.vpindahlokasi2frm t'
      'where no_bukti = :pfilter and kode_brg=:brg'
      'group by no_bukti, kode_brg,nama_brg')
    Variables.Data = {
      0300000002000000080000003A5046494C54455205000000100000003938352D
      313731322D3050303030310000000000040000003A4252470500000007000000
      3031363032350000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000004000000080000004E4F5F42554B5449010000000000080000004B4F
      44455F425247010000000000080000004E414D415F4252470100000000000500
      0000544F54414C010000000000}
    Session = DMFrm.OS
    Left = 160
    Top = 408
    object QSOcek1NO_BUKTI: TStringField
      FieldName = 'NO_BUKTI'
      Size = 22
    end
    object QSOcek1KODE_BRG: TStringField
      FieldName = 'KODE_BRG'
      Size = 50
    end
    object QSOcek1NAMA_BRG: TStringField
      FieldName = 'NAMA_BRG'
      Required = True
      Size = 50
    end
    object QSOcek1TOTAL: TFloatField
      FieldName = 'TOTAL'
    end
  end
  object QCekBuktiSisa2: TOracleDataSet
    SQL.Strings = (
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      
    ...
    Left = 736
    Top = 32
    object QCekBuktiSisa2QTY9: TFloatField
      FieldName = 'QTY9'
    end
    object QCekBuktiSisa2SISA: TFloatField
      FieldKind = fkCalculated
      FieldName = 'SISA'
      Calculated = True
    end
  end
  object QCekBuktiSisaK: TOracleDataSet
    SQL.Strings = (
        ...
        'where a.kd_item=:item and a.no_order=:nota and a.ibukti2=b.ibukt' +
        'i2 and b.ispost ='#39'1'#39' and a.keterangan_d=:keterangan'
      ''
      
        '/*select nvl(sum(a.qty7),0)as qty_sisa from ipisma_db2.bukti_det' +
        'ail a, ipisma_db2.bukti_valid b'
      
        'where a.kd_item=:item and a.no_order=:nota and a.ibukti2=b.ibukt' +
        'i2 and b.ispost = '#39'1'#39'*/')
    Variables.Data = {
      0300000003000000050000003A4954454D050000000700000030313630323500
      00000000050000003A4E4F544105000000100000003938352D313830362D3050
      3030313200000000000B0000003A4B45544552414E47414E0500000007000000
  ...
  object QCekBuktiSisaK2: TOracleDataSet
    SQL.Strings = (
      
        'select * from ipisma_db2.bukti_detail where no_bukti=:nota and k' +
        'd_item=:item and keterangan_d=:keterangan')
    Variables.Data = {
      0300000003000000050000003A4E4F544105000000100000003938352D313830
      362D3050303031320000000000050000003A4954454D05000000070000003031
      3630323500000000000B0000003A4B45544552414E47414E0500000007000000
      4D2E322C35200000000000}
    QBEDefinition.QBEFieldDefs = {
      04000000360000000D0000004942554B54495F44455441494C01000000000006
      0000004942554B5449010000000000080000004E4F5F42554B54490100000000
    ...
    Left = 768
    Top = 376
    object QCekBuktiSisaK2QTY9: TFloatField
      FieldName = 'QTY9'
    end
    object QCekBuktiSisaK2SISA: TFloatField
      FieldKind = fkCalculated
      FieldName = 'SISA'
      Calculated = True
    end
  end
  object QCekBuktiSisaK1: TOracleDataSet
    SQL.Strings = (
        ...
        'where a.kd_item=:item and b.no_bukti=:nota and a.ibukti=b.ibukti' +
        ' and b.kd_transaksi='#39'791'#39' and b.ispost = '#39'1'#39' and a.keterangan_d=' +
        ':keterangan'
      'group by qty9')
    Variables.Data = {
      
      0000000000}
    QBEDefinition.QBEFieldDefs = {0400000001000000080000005154595F53495341010000000000}
    Session = DMFrm.OS
    Left = 808
    ...
    object QCekBuktiSisaK1SISA: TFloatField
      FieldKind = fkCalculated
      FieldName = 'SISA'
      Calculated = True
    end
  ...
  object QTotalInput: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(qty3) as qty, sum(qty7) as kg, sum(((hrg2))*(1-disc/1' +
        '00)*(qty7)) as sub_total from ipisma_db2.bukti_detail a')
    QBEDefinition.QBEFieldDefs = {
      040000000300000003000000515459010000000000020000004B470100000000
      00090000005355425F544F54414C010000000000}
    Session = DMFrm.OS
    Left = 32
    Top = 400
    ...
    object QTotalInputKG: TFloatField
      FieldName = 'KG'
    end
    object QTotalInputSUB_TOTAL: TFloatField
      FieldName = 'SUB_TOTAL'
    end
  end
  object QBatas_Kirim: TOracleDataSet
    SQL.Strings = (
      
        'select outstanding, sisa_kirim from ipisma_db2.Kv15_outstanding_' +
        'customer'
      'where kd_rekanan=:kd_rekanan2')
    Variables.Data = {
      03000000010000000C0000003A4B445F52454B414E414E320300000004000000
      838F010000000000}
    QBEDefinition.QBEFieldDefs = {
    ...
    object QBatas_KirimSISA_KIRIM: TFloatField
      FieldName = 'SISA_KIRIM'
    end
  end
end
