object NotaFrm: TNotaFrm
          ...
          object PageControl2: TPageControl
            ...
            object TabSheet4: TTabSheet
              ...
              object wwDBGrid1: TwwDBGrid
                ...
                Height = 142
                ControlType.Strings = (
                  'KD_SUBLOKASI_GJ2;CustomEdit;LookSatuan;F')
                Selected.Strings = (
                  ...
                  'SATUAN'#9'9'#9'SJ'#9'T'#9'SATUAN'
                  'KD_SUBLOKASI_GJ2'#9'9'#9'NOTA'#9'F'#9'SATUAN'
      ...
      object TabSheet11: TTabSheet
        ...
        object Panel11: TPanel
          ...
          object wwDBGrid10: TwwDBGrid
            ...
            Height = 415
            Selected.Strings = (
              'TGL'#9'11'#9'TGL NOTA'#9'F'
              'KD_ITEM'#9'10'#9'KD ITEM'#9'F'
              'ITEM'#9'25'#9'ITEM'#9'F'
              'KET'#9'15'#9'KET'#9'F'
              'QTY'#9'8'#9'QTY'#9'F'
              'SATUAN'#9'8'#9'SAT'#9'F'
              'HRG'#9'15'#9'HRG'#9'F'
              'MATA_UANG'#9'8'#9'MATA~UANG'#9'F'
              'JNS_ORDER'#9'10'#9'JENIS~ORDER'#9'F'
              'PPN'#9'6'#9'PPN'#9'F'
              'NAMA_REKANAN'#9'40'#9'CUSTOMER'#9'F'
              'NO_NOTA'#9'18'#9'NO NOTA'#9'F'#9'BUKTI'
              'NOS_SJ'#9'18'#9'NO SJ'#9'F'#9'BUKTI')
            IniAttributes.Enabled = True
            IniAttributes.Delimiter = ';;'
            IniAttributes.CheckNewFields = True
            ExportOptions.ExportType = wwgetSYLK
            ...
            BorderStyle = bsNone
            Ctl3D = False
            DataSource = dsQBrowseDetailItem
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
            Font.Name = 'MS Sans Serif'
      ...
      object TabSheet3: TTabSheet
        ...
        object Panel3: TPanel
          ...
          object wwDBDateTimePicker5: TwwDBDateTimePicker
            ...
            TabOrder = 1
            DisplayFormat = 'dd mmm yyyy'
            OnChange = wwDBDateTimePicker5Change
          end
        ...
        object wwDBGrid5: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'QTY'#9'10'#9'Jumlah~Barang'#9'F'
            'DPP'#9'15'#9'MU'#9'F'#9'Jumlah Penjualan'
            'DPP1'#9'15'#9'IDR'#9'F'#9'Jumlah Penjualan'
            'PPN1'#9'15'#9'PPN~Keluaran'#9'F'
            'AKHIR1'#9'20'#9'Jumlah~Piutang Dagan'#9'F')
          IniAttributes.Enabled = True
          IniAttributes.Delimiter = ';;'
          IniAttributes.CheckNewFields = True
          ExportOptions.ExportType = wwgetSYLK
      ...
      object TabSheet7: TTabSheet
        ...
        object wwDBGrid6: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'CARA_BAYAR'#9'8'#9'Cara~Bayar'#9'F'
            'DPP'#9'15'#9'MU'#9'F'#9'Jumlah Penjualan'
            'DPP_IDR'#9'15'#9'IDR'#9'F'#9'Jumlah Penjualan'
            'PPN_IDR'#9'15'#9'PPN~Keluaran'#9'F'
            'AKHIR_IDR'#9'25'#9'Jumlah~Piutang Dagang'#9'F')
          IniAttributes.Enabled = True
          IniAttributes.Delimiter = ';;'
          IniAttributes.CheckNewFields = True
          ExportOptions.ExportType = wwgetSYLK
      ...
      object TabSheet6: TTabSheet
        ...
        object wwDBGrid3: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'NO_NOTA'#9'22'#9'No Invoice'#9'F'
            'CARA_BAYAR'#9'10'#9'Cara~Bayar'#9'F'
            'MU'#9'5'#9'MU'#9'F'
            'QTY7'#9'10'#9'Jumlah~Barang'#9'F'
            'DPP'#9'15'#9'USD'#9'F'#9'DPP'
            'DPP_IDR'#9'15'#9'IDR'#9'F'#9'DPP'
            'PPN'#9'15'#9'PPN~Keluaran'#9'F'
            'AKHIR'#9'15'#9'Jumlah~Piutang Dagang'#9'F')
          IniAttributes.Enabled = True
          IniAttributes.Delimiter = ';;'
          IniAttributes.CheckNewFields = True
          ExportOptions.ExportType = wwgetSYLK
        ...
        object PageControl3: TPageControl
          ...
          object TabSheet9: TTabSheet
            ...
            object wwDBGrid7: TwwDBGrid
              ...
              ControlType.Strings = (
                ...
                'KD_SUBLOKASI_GJ2;CustomEdit;LookSatuan;F'
                'NOTA_OLD;CustomEdit;wwDBLookupComboDlg2;F'
                'STATUS;URL-Link')
              Selected.Strings = (
                'NO_REG'#9'10'#9'REGISTER'#9'T'
                'NOTA_OLD'#9'20'#9'NOMOR NOTA~YANG AKAN DIGANTI'#9'T'
                'NOTA_NEW'#9'18'#9'NOMOR~NOTA BARU'#9'F'
                'CATATAN'#9'35'#9'CATATAN'#9'F'
                'OPR_INSERT'#9'12'#9'USER'#9'T'
                'TGL_INSERT'#9'15'#9'TGL'#9'T'
                'STATUS'#9'15'#9'STATUS'#9'T')
              IniAttributes.Enabled = True
              IniAttributes.Delimiter = ';;'
              IniAttributes.CheckNewFields = True
              ExportOptions.ExportType = wwgetHTML
            ...
            object wwDBLookupComboDlg2: TwwDBLookupComboDlg
              ...
              UserButton1Caption = '&Refresh'
              Selected.Strings = (
                'NO_NOTA'#9'22'#9'NO NOTA'#9'F')
              DataField = 'NOTA_OLD'
              LookupTable = QLookSettingNomor
              LookupField = 'NO_NOTA'
              TabOrder = 1
              AutoDropDown = False
              ShowButton = True
          ...
          object TabSheet10: TTabSheet
            ...
            object Panel7: TPanel
              ...
              TabOrder = 0
              object btnExecGabungNota: TButton
                Left = 70
                Top = 8
                Width = 75
                Height = 25
                ...
                ParentFont = False
                TabOrder = 0
                OnClick = btnExecGabungNotaClick
              end
            end
            object Panel8: TPanel
              ...
              object wwDBGrid8: TwwDBGrid
                ...
                Height = 392
                ControlType.Strings = (
                  'NO_NOTA;CustomEdit;wwDBLookupComboDlg4;F')
                Selected.Strings = (
                  'SEQ'#9'7'#9'KEY'#9'T'#9
                  'NO_NOTA'#9'15'#9'NO NOTA'#9'T'#9
                  'REKANAN'#9'15'#9'CUSTOMER'#9'T'
                  'CATATAN'#9'20'#9'CATATAN'#9#9
                  'OPR_INSERT'#9'10'#9'USER'#9'T'#9
                  'TGL_INSERT'#9'15'#9'TGL INPUT'#9'T'#9
                  'STATUS'#9'8'#9'STATUS'#9'T'#9)
                IniAttributes.Delimiter = ';;'
                TitleColor = clBtnFace
                FixedCols = 0
                ShowHorzScrollBar = True
                Align = alClient
                DataSource = dsQUbahGabungNota
                ReadOnly = True
                TabOrder = 0
            ...
            object Panel9: TPanel
              ...
              object wwDBGrid9: TwwDBGrid
                ...
                Height = 392
                ControlType.Strings = (
                  'NO_NOTA;CustomEdit;wwDBLookupComboDlg5;F')
                Selected.Strings = (
                  'SEQ'#9'5'#9'KEY'#9'T'
                  'NO_NOTA'#9'15'#9'NO NOTA~SEBELUMNYA'#9'T'#9
                  'NO_SJ'#9'15'#9'NO_SJ'#9'T'#9)
                IniAttributes.Delimiter = ';;'
                TitleColor = clBtnFace
                FixedCols = 0
                ShowHorzScrollBar = True
              ...
              object wwDBLookupComboDlg5: TwwDBLookupComboDlg
                ...
                AllowClearKey = False
                UseTFields = False
                OnCloseUp = wwDBLookupComboDlg5CloseUp
  ...
  object QBrowse: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      0400000021000000070000004E4F5F4E4F54410100000000000700000054414E
      ...
      }
    ReadOnly = True
  ...
  object QDetail: TOracleDataSet
    ...
    object QDetailhargaT: TFloatField
      FieldKind = fkCalculated
      FieldName = 'hargaT'
      DisplayFormat = '#,##0.##;(#,##0.##)'
      Calculated = True
    ...
    object QDetailINSURANCE: TFloatField
      FieldName = 'INSURANCE'
    end
    object QDetailCOMMISSION: TFloatField
      FieldName = 'COMMISSION'
    end
    object QDetailFREIGHT: TFloatField
      FieldName = 'FREIGHT'
    end
  end
  ...
  object QRekap_penj: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      
      535F4F52444552010000000000}
    ReadOnly = True
    QueryAllRecords = False
    Session = DMFrm.OS
    Left = 600
    ...
    object QRekap_penjMU: TStringField
      FieldName = 'MU'
      Size = 3
    end
    object QRekap_penjDPP_IDR: TFloatField
      FieldName = 'DPP_IDR'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object QRekap_penjPPN_IDR: TFloatField
      FieldName = 'PPN_IDR'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object QRekap_penjAKHIR_IDR: TFloatField
      FieldName = 'AKHIR_IDR'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object QRekap_penjNO_NOTA: TStringField
      FieldName = 'NO_NOTA'
      Required = True
      Size = 22
    end
  ...
  object QTotal_Rekap: TOracleDataSet
    SQL.Strings = (
        ...
        'select mu, sum(qty7)as qty7, sum(dpp) as dpp, sum(ppn) as ppn, s' +
        'um(akhir) as akhir,'
      
        'sum(dpp_idr) as dpp_idr, sum(ppn_idr) as ppn_idr, sum(akhir_idr)' +
        ' as akhir_idr'
      'from ipisma_db2.vrekap_penjualan'
      'group by mu')
    QBEDefinition.QBEFieldDefs = {
      0400000008000000040000005154593701000000000003000000445050010000
      ...
      0009000000414B4849525F494452010000000000020000004D55010000000000}
    ReadOnly = True
    QueryAllRecords = False
    Session = DMFrm.OS
    Left = 456
    Top = 444
    object QTotal_RekapMU: TStringField
      FieldName = 'MU'
      Size = 3
    end
    ...
    object QTotal_RekapDPP_IDR: TFloatField
      FieldName = 'DPP_IDR'
    end
    object QTotal_RekapPPN_IDR: TFloatField
      FieldName = 'PPN_IDR'
    end
    object QTotal_RekapAKHIR_IDR: TFloatField
      FieldName = 'AKHIR_IDR'
    end
  end
  ...
  object QProcRekap_cus: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db2.proc_rekap_cust(:awal, :akhir);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QProcRekap_cus_maklon: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db2.proc_rekap_cust_maklon(:awal, :akhir,:jns,:jns1);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QProcRekap_cus_lokal: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db2.proc_rekap_cust_lokal(:awal, :akhir, :jns, :jns1);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
      0300000004000000050000003A4157414C0C0000000000000000000000060000
  ...
  object dsQRekap_det: TwwDataSource
    DataSet = QRekap_det
    Left = 616
    Top = 517
  end
  object QRekap_det: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db2.vrekap_penjualan'
      
        'where trunc(tgl) >= :psysdate1 and trunc(tgl) <= :psysdate2 and ' +
        'nama_rekanan =:rekanan '
      'order by no_nota')
    Variables.Data = {
      03000000030000000A0000003A5053595344415445310C000000070000007876
      0701010101000000000A0000003A5053595344415445320C0000000700000078
      76071F01010100000000080000003A52454B414E414E050000000F0000004250
      4B2E20482E204D55415249460000000000}
    QBEDefinition.QBEFieldDefs = {
      
    ...
    Left = 568
    Top = 517
    object QRekap_detJNS_ORDER: TStringField
      FieldName = 'JNS_ORDER'
      Size = 10
    end
    object QRekap_detTGL: TDateTimeField
      FieldName = 'TGL'
    end
    object QRekap_detNO_NOTA: TStringField
      FieldName = 'NO_NOTA'
      Required = True
      Size = 22
    end
    object QRekap_detNO_BUKTI: TStringField
      FieldName = 'NO_BUKTI'
      Size = 22
    end
    object QRekap_detCARA_BAYAR: TStringField
      FieldName = 'CARA_BAYAR'
      Size = 6
    end
    object QRekap_detNAMA_REKANAN: TStringField
      FieldName = 'NAMA_REKANAN'
      Size = 50
    end
    object QRekap_detMU: TStringField
      FieldName = 'MU'
      Size = 3
    end
    object QRekap_detQTY7: TFloatField
      FieldName = 'QTY7'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object QRekap_detDPP: TFloatField
      FieldName = 'DPP'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object QRekap_detPPN: TFloatField
      FieldName = 'PPN'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object QRekap_detAKHIR: TFloatField
      FieldName = 'AKHIR'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object QRekap_detDPP_IDR: TFloatField
      FieldName = 'DPP_IDR'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object QRekap_detPPN_IDR: TFloatField
      FieldName = 'PPN_IDR'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object QRekap_detAKHIR_IDR: TFloatField
      FieldName = 'AKHIR_IDR'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
  end
  object QTot_RekDet: TOracleDataSet
    SQL.Strings = (
      ...
      'from ipisma_db2.vrekap_penjualan'
        ...
        'nama_rekanan =:rekanan ')
    Variables.Data = {
      03000000030000000A0000003A5053595344415445310C000000000000000000
      00000A0000003A5053595344415445320C000000000000000000000008000000
      3A52454B414E414E050000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000007000000040000005154593701000000000003000000445050010000
      0000000300000050504E01000000000005000000414B48495201000000000007
      0000004450505F4944520100000000000700000050504E5F4944520100000000
  ...
  object QSatuan: TOracleDataSet
    SQL.Strings = (
      'select DISTINCT satuan from ipisma_db2.satuan_detail'
      'WHERE satuan is not null AND SATUAN IN ('#39'BALE'#39', '#39'KILO'#39')')
    QBEDefinition.QBEFieldDefs = {
  ...
  object QBrowseDetail2: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      
      000000}
    ReadOnly = True
    Session = DMFrm.OS
    Left = 848
  ...
  object DBQReportRO2: TppDBPipeline
    DataSource = dsQRekap_cus
    OpenDataSource = False
    UserName = 'DBQReportRO2'
    Left = 864
    Top = 277
    object DBQReportRO2ppField1: TppField
      FieldAlias = 'NAMA_REKANAN'
      FieldName = 'NAMA_REKANAN'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQReportRO2ppField2: TppField
      FieldAlias = 'CARA_BAYAR'
      FieldName = 'CARA_BAYAR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQReportRO2ppField3: TppField
      FieldAlias = 'MU'
      FieldName = 'MU'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQReportRO2ppField4: TppField
      FieldAlias = 'QTY'
      FieldName = 'QTY'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQReportRO2ppField5: TppField
      FieldAlias = 'DPP'
      FieldName = 'DPP'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQReportRO2ppField6: TppField
      FieldAlias = 'DPP1'
      FieldName = 'DPP1'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQReportRO2ppField7: TppField
      FieldAlias = 'PPN'
      FieldName = 'PPN'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQReportRO2ppField8: TppField
      FieldAlias = 'PPN1'
      FieldName = 'PPN1'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQReportRO2ppField9: TppField
      FieldAlias = 'AKHIR'
      FieldName = 'AKHIR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQReportRO2ppField10: TppField
      FieldAlias = 'AKHIR1'
      FieldName = 'AKHIR1'
      FieldLength = 0
      DataType = dtNotKnown
  ...
  object ppReportRO2: TppReport
    AutoStop = False
    DataPipeline = DBQReportRO2
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Report'
    PrinterSetup.Orientation = poLandscape
    PrinterSetup.PaperName = 'A4'
  ...
  object ppDBQBrowseDetail2: TppDBPipeline
    DataSource = dsQBrowseDetail2
    OpenDataSource = False
    UserName = 'DBQBrowseDetail1'
    Left = 624
    Top = 429
  end
  object ppReportBrowse2: TppReport
    AutoStop = False
    DataPipeline = ppDBQBrowseDetail2
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Report'
    PrinterSetup.Orientation = poLandscape
    PrinterSetup.PaperName = 'A4'
    ...
    Version = '10.06'
    mmColumnWidth = 197300
    DataPipelineName = 'ppDBQBrowseDetail2'
    object ppTitleBand5: TppTitleBand
      ...
      object ppperiodetodate: TppLabel
        UserName = 'Periode'
        AutoSize = False
        Border.BorderPositions = []
        Border.Color = clBlack
    ...
    object ppSummaryBand5: TppSummaryBand
      ...
      object ppTotalToDate: TppLabel
        UserName = 'TotalToDate'
        Border.BorderPositions = []
        Border.Color = clBlack
        Border.Style = psSolid
        Border.Visible = False
  ...
  object QBrowseToDate: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db2.vnotafrm')
    QBEDefinition.QBEFieldDefs = {
    ...
    Left = 728
    Top = 461
    object QBrowseToDateNILAI: TFloatField
      FieldName = 'NILAI'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object QBrowseToDateNILAI_KURS: TFloatField
      FieldName = 'NILAI_KURS'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
  end
  object DsQBrowseToDate: TwwDataSource
    DataSet = QBrowseToDate
    Left = 768
    Top = 445
  end
  object ppReportRO3: TppReport
    AutoStop = False
    DataPipeline = DBQReportRO3
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Report'
    PrinterSetup.Orientation = poLandscape
    PrinterSetup.PaperName = 'A4'
    ...
    object ppSummaryBand6: TppSummaryBand
      ...
      object ppDBText123: TppDBText
        ...
        TextAlignment = taRightJustified
        Transparent = True
        DataPipelineName = 'DBQTotalRekap1'
        mmHeight = 4233
        mmLeft = 247386
        mmTop = 31750
        mmWidth = 39423
      ...
      object ppDBText124: TppDBText
        ...
        TextAlignment = taRightJustified
        Transparent = True
        DataPipelineName = 'DBQTotalToday'
        mmHeight = 4233
        mmLeft = 207963
        mmTop = 7408
        mmWidth = 36777
      ...
      object ppDBText126: TppDBText
        ...
        Border.Visible = False
        DataField = 'DPP_IDR'
        DataPipeline = DBQTotal_RekapMKL
        DisplayFormat = '#,##0.00;(#,##0.00)'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Name = 'Arial'
        ...
        TextAlignment = taRightJustified
        Transparent = True
        DataPipelineName = 'DBQTotal_RekapMKL'
        mmHeight = 4233
        mmLeft = 207963
        mmTop = 35983
        mmWidth = 36777
      ...
      object ppDBText128: TppDBText
        ...
        TextAlignment = taRightJustified
        Transparent = True
        DataPipelineName = 'DBQTotalTodayMKL'
        mmHeight = 4233
        mmLeft = 207963
        mmTop = 15875
        mmWidth = 36777
      ...
      object ppDBText130: TppDBText
        ...
        TextAlignment = taRightJustified
        Transparent = True
        DataPipelineName = 'DBQTotal_Rekap'
        mmHeight = 4233
        mmLeft = 207963
        mmTop = 27517
        mmWidth = 36777
      ...
      object ppDBText117: TppDBText
        ...
        TextAlignment = taRightJustified
        Transparent = True
        DataPipelineName = 'DBQTotalToday1'
        mmHeight = 4233
        mmLeft = 247386
        mmTop = 11642
        mmWidth = 39423
  ...
  object DBQReportRO3: TppDBPipeline
    DataSource = dsQRekap_penj
    OpenDataSource = False
    UserName = 'DBQReportRO3'
    Left = 936
    Top = 381
    object DBQReportRO3ppField1: TppField
      FieldAlias = 'TGL'
      FieldName = 'TGL'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQReportRO3ppField2: TppField
      FieldAlias = 'NO_BUKTI'
      FieldName = 'NO_BUKTI'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQReportRO3ppField3: TppField
      FieldAlias = 'NAMA_REKANAN'
      FieldName = 'NAMA_REKANAN'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQReportRO3ppField4: TppField
      FieldAlias = 'QTY7'
      FieldName = 'QTY7'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQReportRO3ppField5: TppField
      FieldAlias = 'DPP'
      FieldName = 'DPP'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQReportRO3ppField6: TppField
      FieldAlias = 'PPN'
      FieldName = 'PPN'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQReportRO3ppField7: TppField
      FieldAlias = 'AKHIR'
      FieldName = 'AKHIR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQReportRO3ppField8: TppField
      FieldAlias = 'MU'
      FieldName = 'MU'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQReportRO3ppField9: TppField
      FieldAlias = 'DPP_IDR'
      FieldName = 'DPP_IDR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQReportRO3ppField10: TppField
      FieldAlias = 'PPN_IDR'
      FieldName = 'PPN_IDR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQReportRO3ppField11: TppField
      FieldAlias = 'AKHIR_IDR'
      FieldName = 'AKHIR_IDR'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
    ...
    object DBQReportRO3ppField12: TppField
      FieldAlias = 'NO_NOTA'
      FieldName = 'NO_NOTA'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQReportRO3ppField13: TppField
      FieldAlias = 'CARA_BAYAR'
      FieldName = 'CARA_BAYAR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQReportRO3ppField14: TppField
      FieldAlias = 'JNS_ORDER'
      FieldName = 'JNS_ORDER'
      FieldLength = 0
      DataType = dtNotKnown
  ...
  object DBQTotal_Rekap: TppDBPipeline
    DataSource = dsQTotal_Rekap
    OpenDataSource = False
    UserName = 'DBQTotal_Rekap'
    Left = 416
    Top = 444
    object DBQTotal_RekapppField1: TppField
      FieldAlias = 'QTY7'
      FieldName = 'QTY7'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotal_RekapppField2: TppField
      FieldAlias = 'DPP'
      FieldName = 'DPP'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotal_RekapppField3: TppField
      FieldAlias = 'PPN'
      FieldName = 'PPN'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotal_RekapppField4: TppField
      FieldAlias = 'AKHIR'
      FieldName = 'AKHIR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotal_RekapppField5: TppField
      FieldAlias = 'DPP_IDR'
      FieldName = 'DPP_IDR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotal_RekapppField6: TppField
      FieldAlias = 'PPN_IDR'
      FieldName = 'PPN_IDR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotal_RekapppField7: TppField
      FieldAlias = 'AKHIR_IDR'
      FieldName = 'AKHIR_IDR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotal_RekapppField8: TppField
      FieldAlias = 'MU'
      FieldName = 'MU'
      FieldLength = 0
      DataType = dtNotKnown
  ...
  object dsQTotal_Rekap: TwwDataSource
    DataSet = QTotal_Rekap
    Left = 360
    Top = 444
  end
  object QTotalToday: TOracleDataSet
    SQL.Strings = (
    ...
    Left = 976
    Top = 516
    object QTotalTodayMU: TStringField
      FieldName = 'MU'
      Size = 3
    end
    object QTotalTodayQTY7: TFloatField
      FieldName = 'QTY7'
    end
    object QTotalTodayDPP: TFloatField
      FieldName = 'DPP'
    end
    object QTotalTodayPPN: TFloatField
      FieldName = 'PPN'
    end
    object QTotalTodayAKHIR: TFloatField
      FieldName = 'AKHIR'
    end
    object QTotalTodayDPP_IDR: TFloatField
      FieldName = 'DPP_IDR'
    end
    object QTotalTodayPPN_IDR: TFloatField
      FieldName = 'PPN_IDR'
    end
    object QTotalTodayAKHIR_IDR: TFloatField
      FieldName = 'AKHIR_IDR'
    end
  end
  object dsQTotalToday: TwwDataSource
    DataSet = QTotalToday
    Left = 936
    Top = 516
  end
  object DBQTotalToday: TppDBPipeline
    DataSource = dsQTotalToday
    OpenDataSource = False
    ...
    object DBQTotalTodayppField2: TppField
      FieldAlias = 'DPP'
      FieldName = 'DPP'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalTodayppField3: TppField
      FieldAlias = 'PPN'
      FieldName = 'PPN'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalTodayppField4: TppField
      FieldAlias = 'AKHIR'
      FieldName = 'AKHIR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalTodayppField5: TppField
      FieldAlias = 'DPP_IDR'
      FieldName = 'DPP_IDR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalTodayppField6: TppField
      FieldAlias = 'PPN_IDR'
      FieldName = 'PPN_IDR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalTodayppField7: TppField
      FieldAlias = 'AKHIR_IDR'
      FieldName = 'AKHIR_IDR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalTodayppField8: TppField
      FieldAlias = 'MU'
      FieldName = 'MU'
      FieldLength = 0
      DataType = dtNotKnown
  ...
  object DBQTotalToday1: TppDBPipeline
    DataSource = dsQTotalToday1
    OpenDataSource = False
    UserName = 'DBQTotalToday1'
    Left = 888
    Top = 469
    object DBQTotalToday1ppField1: TppField
      FieldAlias = 'QTY7'
      FieldName = 'QTY7'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalToday1ppField2: TppField
      FieldAlias = 'DPP'
      FieldName = 'DPP'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalToday1ppField3: TppField
      FieldAlias = 'PPN'
      FieldName = 'PPN'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalToday1ppField4: TppField
      FieldAlias = 'AKHIR'
      FieldName = 'AKHIR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalToday1ppField5: TppField
      FieldAlias = 'DPP_IDR'
      FieldName = 'DPP_IDR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalToday1ppField6: TppField
      FieldAlias = 'PPN_IDR'
      FieldName = 'PPN_IDR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalToday1ppField7: TppField
      FieldAlias = 'AKHIR_IDR'
      FieldName = 'AKHIR_IDR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalToday1ppField8: TppField
      FieldAlias = 'MU'
      FieldName = 'MU'
      FieldLength = 0
      DataType = dtNotKnown
  ...
  object dsQTotalToday1: TwwDataSource
    DataSet = QTotalToday1
    Left = 936
    Top = 469
  end
  object QTotalToday1: TOracleDataSet
    SQL.Strings = (
    ...
    Left = 976
    Top = 469
    object QTotalToday1MU: TStringField
      FieldName = 'MU'
      Size = 3
    end
    object QTotalToday1QTY7: TFloatField
      FieldName = 'QTY7'
    end
    object QTotalToday1DPP: TFloatField
      FieldName = 'DPP'
    end
    object QTotalToday1PPN: TFloatField
      FieldName = 'PPN'
    end
    object QTotalToday1AKHIR: TFloatField
      FieldName = 'AKHIR'
    end
    object QTotalToday1DPP_IDR: TFloatField
      FieldName = 'DPP_IDR'
    end
    object QTotalToday1PPN_IDR: TFloatField
      FieldName = 'PPN_IDR'
    end
    object QTotalToday1AKHIR_IDR: TFloatField
      FieldName = 'AKHIR_IDR'
    end
  end
  object dsQTotalRekap1: TwwDataSource
    DataSet = QTotalRekap1
    Left = 360
    Top = 484
  end
  object DBQTotalRekap1: TppDBPipeline
    DataSource = dsQTotalRekap1
    OpenDataSource = False
    UserName = 'DBQTotal_Rekap1'
    Left = 416
    Top = 485
    object DBQTotalRekap1ppField1: TppField
      FieldAlias = 'QTY7'
      FieldName = 'QTY7'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalRekap1ppField2: TppField
      FieldAlias = 'DPP'
      FieldName = 'DPP'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalRekap1ppField3: TppField
      FieldAlias = 'PPN'
      FieldName = 'PPN'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalRekap1ppField4: TppField
      FieldAlias = 'AKHIR'
      FieldName = 'AKHIR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalRekap1ppField5: TppField
      FieldAlias = 'DPP_IDR'
      FieldName = 'DPP_IDR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalRekap1ppField6: TppField
      FieldAlias = 'PPN_IDR'
      FieldName = 'PPN_IDR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalRekap1ppField7: TppField
      FieldAlias = 'AKHIR_IDR'
      FieldName = 'AKHIR_IDR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalRekap1ppField8: TppField
      FieldAlias = 'MU'
      FieldName = 'MU'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object ppMasterFieldLink10: TppMasterFieldLink
      MasterFieldName = 'IBUKTI'
      GuidCollationType = gcString
      DetailFieldName = 'IBUKTI'
      DetailSortOrder = soAscending
  ...
  object QTotalRekap1: TOracleDataSet
    SQL.Strings = (
    ...
    Left = 464
    Top = 492
    object QTotalRekap1MU: TStringField
      FieldName = 'MU'
      Size = 3
    end
    object QTotalRekap1QTY7: TFloatField
      FieldName = 'QTY7'
    end
    object QTotalRekap1DPP: TFloatField
      FieldName = 'DPP'
    end
    object QTotalRekap1PPN: TFloatField
      FieldName = 'PPN'
    end
    object QTotalRekap1AKHIR: TFloatField
      FieldName = 'AKHIR'
    end
    object QTotalRekap1DPP_IDR: TFloatField
      FieldName = 'DPP_IDR'
    end
    object QTotalRekap1PPN_IDR: TFloatField
      FieldName = 'PPN_IDR'
    end
    object QTotalRekap1AKHIR_IDR: TFloatField
      FieldName = 'AKHIR_IDR'
    end
  end
  object dsQtotal_RekapMKL: TwwDataSource
    DataSet = QTotal_RekapMKL
    Left = 360
    Top = 404
  end
  object DBQTotal_RekapMKL: TppDBPipeline
    DataSource = dsQtotal_RekapMKL
    OpenDataSource = False
    UserName = 'DBQTotal_RekapMKL'
    Left = 416
    Top = 404
    object DBQTotal_RekapMKLppField1: TppField
      FieldAlias = 'QTY7'
      FieldName = 'QTY7'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotal_RekapMKLppField2: TppField
      FieldAlias = 'DPP'
      FieldName = 'DPP'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotal_RekapMKLppField3: TppField
      FieldAlias = 'PPN'
      FieldName = 'PPN'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotal_RekapMKLppField4: TppField
      FieldAlias = 'AKHIR'
      FieldName = 'AKHIR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotal_RekapMKLppField5: TppField
      FieldAlias = 'DPP_IDR'
      FieldName = 'DPP_IDR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotal_RekapMKLppField6: TppField
      FieldAlias = 'PPN_IDR'
      FieldName = 'PPN_IDR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotal_RekapMKLppField7: TppField
      FieldAlias = 'AKHIR_IDR'
      FieldName = 'AKHIR_IDR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotal_RekapMKLppField8: TppField
      FieldAlias = 'MU'
      FieldName = 'MU'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object ppMasterFieldLink11: TppMasterFieldLink
      MasterFieldName = 'IBUKTI'
      GuidCollationType = gcString
      DetailFieldName = 'IBUKTI'
      DetailSortOrder = soAscending
  ...
  object QTotal_RekapMKL: TOracleDataSet
    SQL.Strings = (
    ...
    Left = 448
    Top = 356
    object QTotal_RekapMKLMU: TStringField
      FieldName = 'MU'
      Size = 3
    end
    object QTotal_RekapMKLQTY7: TFloatField
      FieldName = 'QTY7'
    end
    object QTotal_RekapMKLDPP: TFloatField
      FieldName = 'DPP'
    end
    object QTotal_RekapMKLPPN: TFloatField
      FieldName = 'PPN'
    end
    object QTotal_RekapMKLAKHIR: TFloatField
      FieldName = 'AKHIR'
    end
    object QTotal_RekapMKLDPP_IDR: TFloatField
      FieldName = 'DPP_IDR'
    end
    object QTotal_RekapMKLPPN_IDR: TFloatField
      FieldName = 'PPN_IDR'
    end
    object QTotal_RekapMKLAKHIR_IDR: TFloatField
      FieldName = 'AKHIR_IDR'
    end
  end
  object DBQTotalTodayMKL: TppDBPipeline
    DataSource = dsQTotalTodayMKL
    OpenDataSource = False
    UserName = 'DBQTotalTodayMKL'
    Left = 888
    Top = 429
    object DBQTotalTodayMKLppField1: TppField
      FieldAlias = 'QTY7'
      FieldName = 'QTY7'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalTodayMKLppField2: TppField
      FieldAlias = 'DPP'
      FieldName = 'DPP'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalTodayMKLppField3: TppField
      FieldAlias = 'PPN'
      FieldName = 'PPN'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalTodayMKLppField4: TppField
      FieldAlias = 'AKHIR'
      FieldName = 'AKHIR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalTodayMKLppField5: TppField
      FieldAlias = 'DPP_IDR'
      FieldName = 'DPP_IDR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalTodayMKLppField6: TppField
      FieldAlias = 'PPN_IDR'
      FieldName = 'PPN_IDR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalTodayMKLppField7: TppField
      FieldAlias = 'AKHIR_IDR'
      FieldName = 'AKHIR_IDR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object DBQTotalTodayMKLppField8: TppField
      FieldAlias = 'MU'
      FieldName = 'MU'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object ppMasterFieldLink12: TppMasterFieldLink
      MasterFieldName = 'IBUKTI'
      GuidCollationType = gcString
      DetailFieldName = 'IBUKTI'
      DetailSortOrder = soAscending
  ...
  object dsQTotalTodayMKL: TwwDataSource
    DataSet = QTotalTodayMKL
    Left = 936
    Top = 429
  end
  object QTotalTodayMKL: TOracleDataSet
    SQL.Strings = (
    ...
    Left = 976
    Top = 429
    object QTotalTodayMKLMU: TStringField
      FieldName = 'MU'
      Size = 3
    end
    object QTotalTodayMKLQTY7: TFloatField
      FieldName = 'QTY7'
    end
    object QTotalTodayMKLDPP: TFloatField
      FieldName = 'DPP'
    end
    object QTotalTodayMKLPPN: TFloatField
      FieldName = 'PPN'
    end
    object QTotalTodayMKLAKHIR: TFloatField
      FieldName = 'AKHIR'
    end
    object QTotalTodayMKLDPP_IDR: TFloatField
      FieldName = 'DPP_IDR'
    end
    object QTotalTodayMKLPPN_IDR: TFloatField
      FieldName = 'PPN_IDR'
    end
    object QTotalTodayMKLAKHIR_IDR: TFloatField
      FieldName = 'AKHIR_IDR'
    end
  end
  object QLookSettingNomor: TOracleDataSet
    SQL.Strings = (
      
        'select distinct t.kd_rekanan, y.nama_rekanan as rekanan, t.ibukt' +
        'i, t.no_nota, x.no_bukti as no_sj'
      'from ipisma_db2.bukti t'
      'left join ipisma_db2.bukti_detail x on t.ibukti=x.ibukti'
      'left join ipisma_db1.rekanan y on t.kd_rekanan=y.kd_rekanan'
      
        'where t.kd_transaksi = '#39'995'#39' and t.tgl >= to_date('#39'01/01/2022'#39','#39 +
        'dd/mm/yyyy'#39') and t.ibukti in (select ibukti from ipisma_db2.bukt' +
        'i_detail)'
      'and t.kd_rekanan LIKE :pkd_rekanan'
      'order by no_nota desc')
    Variables.Data = {
      03000000010000000C0000003A504B445F52454B414E414E0500000002000000
      250000000000}
    SequenceField.Field = 'SEQ'
    SequenceField.Sequence = 'IPISMA_DB2.SEQ_UBAH_NOTA'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      0400000005000000070000004E4F5F4E4F544101000000000006000000494255
      4B5449010000000000050000004E4F5F534A0100000000000A0000004B445F52
      454B414E414E0100000000000700000052454B414E414E010000000000}
    QueryAllRecords = False
    ...
    Left = 316
    Top = 265
    object QLookSettingNomorIBUKTI: TFloatField
      FieldName = 'IBUKTI'
      Required = True
    end
    object QLookSettingNomorNO_NOTA: TStringField
      FieldName = 'NO_NOTA'
      Required = True
      Size = 22
    end
    object QLookSettingNomorNO_SJ: TStringField
      FieldName = 'NO_SJ'
      Size = 22
    end
    object QLookSettingNomorKD_REKANAN: TFloatField
      FieldName = 'KD_REKANAN'
    end
    object QLookSettingNomorREKANAN: TStringField
      FieldName = 'REKANAN'
      Size = 50
    end
  end
  object QUbahNomor: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db2.proc_ubah_no_nota(:pseq, :pnota_old, :pnota_new);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
      03000000030000000A0000003A504E4F54415F4F4C4405000000000000000000
      00000A0000003A504E4F54415F4E455705000000000000000000000005000000
      3A50534551030000000000000000000000}
    Left = 280
    Top = 296
  end
  object QSettingNoNota: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db2.ubah_nota a'
      ':myparam')
    Variables.Data = {
    ...
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      
      000006000000535441545553010000000000}
    Session = DMFrm.OS
    BeforePost = QSettingNoNotaBeforePost
    OnNewRecord = QSettingNoNotaNewRecord
    Left = 337
    Top = 335
    object QSettingNoNotaTGL_INSERT: TDateTimeField
      FieldName = 'TGL_INSERT'
    end
    object QSettingNoNotaOPR_INSERT: TStringField
      FieldName = 'OPR_INSERT'
      Size = 30
    end
    object QSettingNoNotaNOTA_OLD: TStringField
      FieldName = 'NOTA_OLD'
      Size = 22
    end
    object QSettingNoNotaNOTA_NEW: TStringField
      FieldName = 'NOTA_NEW'
      Size = 22
    end
    object QSettingNoNotaNO_REG: TFloatField
      FieldName = 'NO_REG'
    end
    object QSettingNoNotaCATATAN: TStringField
      FieldName = 'CATATAN'
      Size = 255
    end
    object QSettingNoNotaSEQ: TFloatField
      FieldName = 'SEQ'
      Required = True
    end
    object QSettingNoNotaSTATUS: TStringField
      FieldName = 'STATUS'
      Required = True
      Size = 15
    end
  end
  object dsQSettingNoNota: TDataSource
    DataSet = QSettingNoNota
    Left = 385
    Top = 319
  end
  object QUbahGabungNota: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db2.ubah_gabung_nota a'
      ':myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    SequenceField.Field = 'SEQ'
    SequenceField.Sequence = 'IPISMA_DB2.SEQ_GABUNG_NOTA'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      
      00000000}
    Session = DMFrm.OS
    Left = 401
    Top = 271
    object QUbahGabungNotaSEQ: TFloatField
      DisplayLabel = 'KEY'
      DisplayWidth = 7
      FieldName = 'SEQ'
      Required = True
    end
    object QUbahGabungNotaNO_NOTA: TStringField
      DisplayLabel = 'NO NOTA'
      DisplayWidth = 15
      FieldName = 'NO_NOTA'
      Size = 15
    end
    object QUbahGabungNotaREKANAN: TStringField
      DisplayLabel = 'CUSTOMER'
      DisplayWidth = 15
      FieldName = 'REKANAN'
      Size = 25
    end
    object QUbahGabungNotaCATATAN: TStringField
      DisplayWidth = 20
      FieldName = 'CATATAN'
      Size = 225
    end
    object QUbahGabungNotaOPR_INSERT: TStringField
      DisplayLabel = 'USER'
      DisplayWidth = 10
      FieldName = 'OPR_INSERT'
      Size = 128
    end
    object QUbahGabungNotaTGL_INSERT: TDateTimeField
      DisplayLabel = 'TGL INPUT'
      DisplayWidth = 15
      FieldName = 'TGL_INSERT'
    end
    object QUbahGabungNotaSTATUS: TStringField
      DisplayWidth = 8
      FieldName = 'STATUS'
      Required = True
      Size = 15
    end
    object QUbahGabungNotaIBUKTI: TFloatField
      DisplayWidth = 7
      FieldName = 'IBUKTI'
      Visible = False
    end
    object QUbahGabungNotaKD_REKANAN: TFloatField
      DisplayWidth = 10
      FieldName = 'KD_REKANAN'
      Visible = False
    end
  end
  object dsQUbahGabungNota: TDataSource
    DataSet = QUbahGabungNota
    Left = 457
    Top = 287
  end
  object QUGND: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db2.ubah_gabung_nota_d a'
      'where seq = :seq')
    Variables.Data = {0300000001000000040000003A534551040000000000000000000000}
    SequenceField.Field = 'SEQ_D'
    SequenceField.Sequence = 'IPISMA_DB2.SEQ_GABUNG_NOTA'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      040000000500000003000000534551010000000000070000004E4F5F4E4F5441
      010000000000060000004942554B5449010000000000050000005345515F4401
      0000000000050000004E4F5F534A010000000000}
    Master = QUbahGabungNota
    MasterFields = 'SEQ'
    DetailFields = 'SEQ'
    Session = DMFrm.OS
    Left = 465
    Top = 239
    object QUGNDSEQ: TFloatField
      DisplayLabel = 'KEY'
      DisplayWidth = 5
      FieldName = 'SEQ'
      Required = True
    end
    object QUGNDNO_NOTA: TStringField
      DisplayLabel = 'NO NOTA~SEBELUMNYA'
      DisplayWidth = 15
      FieldName = 'NO_NOTA'
      Size = 15
    end
    object QUGNDNO_SJ: TStringField
      DisplayWidth = 15
      FieldName = 'NO_SJ'
      Size = 15
    end
    object QUGNDSEQ_D: TFloatField
      DisplayWidth = 5
      FieldName = 'SEQ_D'
      Required = True
      Visible = False
    end
    object QUGNDIBUKTI: TFloatField
      DisplayWidth = 10
      FieldName = 'IBUKTI'
      Visible = False
    end
  end
  object dsUGND: TDataSource
    DataSet = QUGND
    Left = 521
    Top = 255
  end
  object QUbahGabungNota2: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db2.proc_ubah_gabung_nota;'
      'end;')
    Session = DMFrm.OS
    Left = 424
    Top = 240
  end
  object QBrowseDetailItem: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db2.vpenjualan_detail'
      'where tgl >= :pawal and tgl <= :pakhir'
      ':pmyparams')
    Variables.Data = {
      0300000003000000060000003A504157414C0C00000000000000000000000700
      00003A50414B4849520C00000000000000000000000A0000003A504D59504152
      414D53010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      
      485247010000000000}
    ReadOnly = True
    QueryAllRecords = False
    Session = DMFrm.OS
    Left = 720
    Top = 8
    object QBrowseDetailItemTGL: TDateTimeField
      FieldName = 'TGL'
      DisplayFormat = 'DD MMM YY'
    end
    object QBrowseDetailItemNO_NOTA: TStringField
      FieldName = 'NO_NOTA'
      Required = True
      Size = 22
    end
    object QBrowseDetailItemNOS_SJ: TStringField
      FieldName = 'NOS_SJ'
      Size = 22
    end
    object QBrowseDetailItemJNS_ORDER: TStringField
      FieldName = 'JNS_ORDER'
      Size = 10
    end
    object QBrowseDetailItemMATA_UANG: TStringField
      FieldName = 'MATA_UANG'
      Size = 3
    end
    object QBrowseDetailItemKD_REKANAN: TFloatField
      FieldName = 'KD_REKANAN'
    end
    object QBrowseDetailItemNAMA_REKANAN: TStringField
      FieldName = 'NAMA_REKANAN'
      Size = 50
    end
    object QBrowseDetailItemKD_ITEM: TStringField
      FieldName = 'KD_ITEM'
      Size = 50
    end
    object QBrowseDetailItemITEM: TStringField
      FieldName = 'ITEM'
      Size = 255
    end
    object QBrowseDetailItemKET: TStringField
      FieldName = 'KET'
      Size = 255
    end
    object QBrowseDetailItemQTY: TFloatField
      FieldName = 'QTY'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object QBrowseDetailItemSATUAN: TStringField
      FieldName = 'SATUAN'
      Size = 4
    end
    object QBrowseDetailItemHRG: TFloatField
      FieldName = 'HRG'
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object QBrowseDetailItemPPN: TStringField
      FieldName = 'PPN'
      Size = 3
    end
  end
  object dsQBrowseDetailItem: TwwDataSource
    DataSet = QBrowseDetailItem
    Left = 752
    Top = 16
  end
end
